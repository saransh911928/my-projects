const MovieReducer = (state, action) => {
    switch (action.type) { 
        ...
        return { ...state, isFetching: true, error: false };
         ...
         return { movies: state.movies.filter((movie) => movie._id !== action.payload), isFetching: false, error: false }; 
        ...
        return { ...state, isFetching: true, error: false };
         ...
         return { movies: [action.payload, ...state.movies], isFetching: false, error: false };
